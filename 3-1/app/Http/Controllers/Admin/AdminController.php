...
class AdminController extends Controller
{
    ...
    public function statements($account_id=null) {
        ...
        if($account) {
            ...
            $statements = Statement::where('account_id', $account->id)->where('pdf', 'like', '%statements/%')->get();
    ...
    public function statementsYear($account_id=null) {
        if (!($user = Auth::user())) return redirect('/');
        ...
        if($account) {
            ...
            return view('admin.statements-year', compact('dbvar', 'alerts', 'accounts', 'statements', 'account_id'));
        } else {
            return abort('404');
        }
    }
