    ...
    public function year_view($id) {
        ...
        $content = '<page style="font-size: 14pt">
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-bottom: 50px">
                            ...
                            <tr style="vertical-align: top;">
                                <td style="width: 50%; padding: 0">
                                    <div style="padding: 0 0; margin-left: 40px;">Total Management Fees:</div>
                                </td>
                                <td style="width: 50%; padding: 0">
                                    <div style="padding: 0 0 10px 40px; margin-right: 40px;">€ '.number_format($total_management, 2).'</div>
                                </td>
                            </tr>
                            <tr style="vertical-align: top;">
                                <td style="width: 50%; padding: 0">
                                    <div style="padding: 0 0 20px 0; margin-left: 40px; border-bottom: 1px solid;">Total NET P&L for year '.number_format($year-1, 0, '', '').' </div>
                                </td>
                                <td style="width: 50%; padding: 0">
                                    <div style="padding: 0 0 20px 40px; margin-right: 40px; border-bottom: 1px solid;">€ '.number_format($total_PL, 2).'</div>
                                </td>
                            </tr>
                            <tr style="vertical-align: top;">
                                <td style="width: 50%; padding: 0">
