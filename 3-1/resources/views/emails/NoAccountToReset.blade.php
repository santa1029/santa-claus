                                                ...
                                                <table class="card-body" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                            <h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">There is an issue with your reset</h1>
                                                            ...
                                                            <h5 class="text-teal-700" style="color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">We're sorry, but we cannot seem to locate the account to reset.</h5>
                                                            ...
                                                            <div class="space-y-3">
                                                                ...
                                                                <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">
                                                                    We are unable to locate the account you wish to reset. Our support team is, or shortly will be, looking into it. Rest assured we'll do everything to have this figured out in the shortest time possible.
                                                                    Should you have any more information, please contact us by replying to this email, or by using the live chat on our website
                                                                ...
                                                                <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">
                                                                    Please, do not re-order a reset of the same account before we have fixed the issue.
                                                                </p>
                                                            </div>
                                                            <table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                                                <tbody>
                                                            ...
                                                            <p class="text-xs" style="line-height: 14.4px; font-size: 12px; width: 100%; margin: 0;" align="left">You are receiving this email because you ordered a reset of an account at proppers.io. You will receive follow-up emails to resolve this issue.</p>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
