        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <canvas id="polarArea" data-colors='["--bs-danger", "--bs-success", "--bs-warning", "--bs-primary"]' height="300"> </canvas>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <canvas id="radar" data-colors='["--bs-success-rgb, 0.2", "--bs-success", "--bs-primary-rgb, 0.2", "--bs-primary"]' height="300"></canvas>
                </div>
            </div>
        </div> <!-- end col -->
    </div> <!-- end row -->
