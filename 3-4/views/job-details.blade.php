        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="{{URL::asset('assets/images/companies/adobe-photoshop.svg')}}" alt="" height="50" class="mx-auto d-block">
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body border-bottom">
                <div class="d-flex">
                    <img src="{{URL::asset('assets/images/companies/wechat.svg')}}" alt="" height="50">
