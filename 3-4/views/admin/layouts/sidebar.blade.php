    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ url('admin/statements') }}" class="waves-effect">
                        <i class="bx bx-food-menu"></i>
                        <span>Month Statements</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('admin/statements-year') }}" class="waves-effect">
                        <i class="bx bx-food-menu"></i>
                        <span>Year Statements</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ url('admin/accounts') }}" class="waves-effect">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ url('admin/transactions/user') }}" key="t-transactions-user">User</a></li>
                        <li><a href="{{ url('admin/transactions/account') }}" key="t-transactions-account">Account</a>
                        </li>
                    </ul>
                </li>
