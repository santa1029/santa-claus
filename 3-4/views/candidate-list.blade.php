...
@section('title') @lang('translation.Candidate') @lang('translation.List') @endsection

@section('css')
<link rel="stylesheet" type="text/css" href="{{ URL::asset('/assets/libs/bootstrap-datepicker/bootstrap-datepicker.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('/assets/libs/select2/select2.min.css') }}" rel="stylesheet">
@endsection
...
<script src="{{URL::asset('assets/js/pages/candidate-list.init.js')}}"></script>
