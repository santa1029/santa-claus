        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="add-eombalance-form">
                    ...
                    <div class="mb-3">
                        <label>Date :</label>
                        <div class="input-group" id="new_date">
                            <input type="text" class="form-control" placeholder="{{ (new DateTime())->format('Y-m-d') }}" id="new_datepicker"
                                data-date-format="yyyy-mm-dd" data-date-container='#new_date' data-provide="datepicker"
                                data-date-autoclose="true">
                            <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                        </div>
                        <div class="text-danger" id="new_dateError" data-ajax-feedback="new_date"></div>
                    </div>
...
<script>
    ...
    $(document).ready(() => {
        ...
        $('#add-eombalance-form').on('submit', function(event) {
            ...
            var new_date = $("#new_datepicker").val();
            ...
            $.ajax({
                ...
                error: function(response) {
                    ...
                    $('#new_dateError').text(response.responseJSON.errors.new_date);
                }
            });
        });
