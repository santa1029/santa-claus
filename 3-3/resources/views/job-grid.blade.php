...
@section('title') @lang('translation.Job_Grid') @endsection

@section('content')

@component('components.breadcrumb')
@slot('li_1') Jobs @endslot
@slot('title') Jobs Grid @endslot
@endcomponent
                ...
                <form action="javascript:void(0);">
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-2 col-lg-6">
                            <div class="position-relative">
                                <div id="datepicker1">
                                    <input type="text" class="form-control" placeholder="Select date" data-date-format="dd M, yyyy" data-date-container='#datepicker1' data-provide="datepicker" data-date-autoclose="true">
                                </div><!-- input-group -->
                            </div>
                        </div>
                        <!--end col-->
                        ...
                        <div class="collapse" id="collapseExample">
                            <div>
                                <div class="row g-3">
                                    ...
                                    <div class="col-xxl-4 col-lg-4">
                                        <div class="position-relative">
                                            <label for="qualificationInput" class="form-label fw-semibold">Qualification</label>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/adobe.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/adobe-photoshop.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Product Designer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
                    </li>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/airbnb.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Marketing Director</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
                    </li>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/amazon.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Project Manager</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
                    </li>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/flutter.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">HTML Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
                    </li>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/mailchimp.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Business Associate</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
                    </li>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/line.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Product Sales Specialist</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
                    </li>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/spotify.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/wordpress.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/upwork.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/sass.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{URL::asset('assets/images/companies/reddit.svg')}}" alt="" height="50" class="mb-3">
                <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <p class="text-muted fs-14 mb-1">Skote Technology Pvt.Ltd</p>
